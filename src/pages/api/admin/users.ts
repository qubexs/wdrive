...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  if (req.method === "POST") {
    const { email, password, name, role, canDownload, canEdit, canDelete, canUpload, canRename, canMove, canCopy, canShare, isActive, storageLimitBytes } = req.body as {
      email?: string;
      password?: string;
      name?: string;
      role?: string;
  ...
  if (req.method === "PATCH") {
    const { userId, name, role, canDownload, canEdit, canDelete, canUpload, canRename, canMove, canCopy, canShare, isActive, isApproved } = req.body as {
      userId?: string;
      name?: string;
      role?: string;
      canDownload?: boolean;
