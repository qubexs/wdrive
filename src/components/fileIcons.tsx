import { AiFillFile, AiFillFileExcel, AiFillFilePpt, AiFillFileZip } from "react-icons/ai";
...
const fileIcons: FileIcons = {
  ...
  xls: <AiFillFileExcel className="h-full w-full text-[#0b8043]" />,
  xlsx: <AiFillFileExcel className="h-full w-full text-[#0b8043]" />,
  ppt: <AiFillFilePpt className="h-full w-full text-[#c5221f]" />,
  pptx: <AiFillFilePpt className="h-full w-full text-[#c5221f]" />,
  pps: <AiFillFilePpt className="h-full w-full text-[#c5221f]" />,
  ppsx: <AiFillFilePpt className="h-full w-full text-[#c5221f]" />,
